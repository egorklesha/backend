    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_estimate', models.DateTimeField(default=datetime.datetime(2023, 12, 4, 12, 14, 1, 918360, tzinfo=datetime.timezone.utc), verbose_name='Дата расчета')),
                ('date_created', models.DateTimeField(default=datetime.datetime(2023, 12, 4, 12, 14, 1, 918543, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='indicators/default.jpg', upload_to='', verbose_name='Фото')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.FloatField(default=1000, verbose_name='Значение счётчика')),
                ('estimate', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='calculation.estimate')),
                ('indicator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='calculation.indicator')),
            ],
            options={
